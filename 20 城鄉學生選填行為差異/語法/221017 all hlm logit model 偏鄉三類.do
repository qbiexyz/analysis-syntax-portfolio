...
melogit `1'  male lictyp retest chimiss engmiss mathmiss ///
			 grade b1.rural_3 b1.hscity4 sschpub  ///
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\選滿考5科 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\選滿6志願 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\全選公立大學 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\選公立大學佔大多數 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\志願一階大多數都通過 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\有被分發且沒有放棄(all) 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\有被分發且沒有放棄(1階通過) 國英數平均 偏鄉三類_output1017.txt" ,replace text 
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\有被分發且沒有放棄(二階有正備取，不一定有備上) 國英數平均 偏鄉三類_output1017.txt" ,replace text  
...
log using "rc_output\偏鄉\out1017_永健\model\偏鄉三類\有被分發且沒有放棄(二階有被分發＝有正取或備上) 國英數平均 偏鄉三類_output1017.txt" ,replace text  
/*
