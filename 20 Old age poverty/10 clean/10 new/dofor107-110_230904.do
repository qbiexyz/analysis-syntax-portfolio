...
use "10 data\家庭收支調查\109\inc109.dta",clear
*/
/*****************************************************************************
# market income =  
...
*****************************************************************************/
* 戶長性別 
recode a7 (1 = 0 "男")(2 = 1 "女")(* = .), gen(headfemale)
lab var headfemale "戶長性別(女)"

* headeduy:戶長教育年數 
recode a11 (1 = 0)(2 = 3)(3 = 6)(4 = 9)(5 6 = 12)(7 = 14) ///
           (8 = 16)(9 = 18)(10 = 23)(* = .), gen(headeduy)
lab var headeduy "戶長教育年數"

recode a11 (1/4 = 1 "國家以下")(5/6 = 2 "高中職")(7/10 =3 "大專/學以上") ///
           (* = .), gen(headeduc)
...
gen hcomposit = 0
replace hcomposit = 1 if a18 == 321  
replace hcomposit = 2 if a18 == 101  
replace hcomposit = 3 if a18 == 322  
replace hcomposit = 4 if a18 == 102  
replace hcomposit = 5 if a18 == 421 | a18 == 422
replace hcomposit = 6 if a18 == 201 | a18 == 202 
replace hcomposit = 7 if a18 == 431 | a18 == 432
replace hcomposit = 8 if a18 == 331 | a18 == 332
replace hcomposit = 9 if hcomposit==0
lab value hcomposit hclabel
...
reshape long b1_ b2_ b3_ b4_ b5_ b6_ b7_ b8_ b9_ b10_ b11_ b12_ b13_ b14_ ///
             b15_ b16_ b17_ b18_ b19_ b20_ b21_ b22_ b23_ b24_ b25_ ///
			 , i(id) j(rank)
...
recode b16_ (1/60 92= 1) (0 91 93/97=0),gen(married)
gen headmarried0 = 0
...
*個人教育程度
recode b5_ (1 = 0)(2 = 3)(3 = 6)(4 = 9)(5 6 = 12)(7 = 14) ///
           (8 = 16)(9 = 18)(10 = 23)(* = .), gen(eduy)
lab var eduy "教育年數"

recode b5_ (1/4 = 1 "國家以下")(5/6 = 2 "高中職")(7/10 =3 "大專/學以上") ///
           (* = .), gen(educ)
lab var educ "教育程度"
...
*與戶長關係
recode b2_ (1/2 = 0 "本人/配偶")(3/4 = 1 "子女")(5 6 11 = 2 "父母輩") ///
           (0 7/10 12/14 = 3 "其他"),gen(headrelation)
...
*****************************************************************************/
*產業
recode b8_ (0 = 0) (1 2 3 = 1) (5 8 35 36 41 = 2) (45/99 = 3), gen(industry_t3)
...
*受雇型態
*無酬家屬工作者為自雇
recode b12_ (0 6 7 8 9 = 0) (1 = 1) (2 = 3) (3 4 = 4) (5 = 5), gen(hire)
	/*
	!自107年後受顧人員無法以健保為公保區分!所以目前皆編碼為受雇於私部門
...
replace class = 2 if ( (b9_ >= 1 & b9_ <= 3) | b9_ == 10 ) & ///
                     ( hire == 2 | hire == 3 )
lab var class "階級"	
