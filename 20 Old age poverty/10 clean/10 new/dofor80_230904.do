...
******************************************************************************
est clear
use "10 data\家庭收支調查\80\inc80.dta",clear
*/
/*
* 若是亂碼
cd "D:\Dropbox\工作\翠莪老師_work\poverty3\Old age poverty\10 data\家庭收支調查\80\"
unicode encoding set Big5
unicode translate "inc80.dta" , invalid(ignore) transutf8 nodata
*刪除資料夾
