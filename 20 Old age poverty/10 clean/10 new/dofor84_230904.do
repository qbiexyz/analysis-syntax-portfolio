...
******************************************************************************
est clear
use "10 data\家庭收支調查\84\inc84.dta",clear
*/
/*
* 若是亂碼
cd "D:\Dropbox\工作\翠莪老師_work\Old age poverty\10 data\家庭收支調查\79\"
unicode encoding set Big5
unicode translate "inc79.dta" , invalid(ignore) transutf8 nodata
*刪除資料夾
