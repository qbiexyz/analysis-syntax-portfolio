...
log using "output/mlogit TYP2014_240321.txt", text replace

mlogit ///
      group3_14 J314 gender14 b1.edu6_14 b1.worksectorn14 b1.firmsize14 ///
	  b1.supervising14 nightshift14 holidayshift14 urbanization14 ///
	  if touse2 , b(3) vce(bootstrap)
est store m1

mprobit ///
      group3_14 J314 gender14 b1.edu6_14 b1.worksectorn14 b1.firmsize14 ///
	  b1.supervising14 nightshift14 holidayshift14 urbanization14 ///
	  if touse2 , base(3) nolog
est store m2
...
log using "output/mlogit TYP2017_240321.txt", text replace

mlogit ///
      group3_17 J317 gender17 b1.edu6_17 b1.worksectorn17 b1.firmsize17 ///
	  b1.supervising17 nightshift17 holidayshift17 urbanization17 ///
	  if touse2 , b(3) vce(bootstrap)
est store m3
